	...
	<div class="navbar bg-base-100">
		...
		<div class="flex-none">
			<ul class="menu menu-horizontal px-1">
				...
				<li><a href="/sites/achievements">Achievements</a></li>
				<li><a href="/sites/contactme">Contact Me</a></li>
			</ul>
		</div>
	</div>
</header>
...
<footer class="footer footer-center p-10 bg-primary text-primary-content">
	...
	<div>
		<div class="grid grid-flow-col gap-4">
			<a href="https://github.com/AreOlsen"
				><svg
					width="24"
					height="24"
					xmlns="http://www.w3.org/2000/svg"
				...
				></a
			>
			<a href="https://www.youtube.com/@ao_coding3670/featured"
				...
				></a
			>
			<a href="https://discord.gg/9snq8SfpZ9"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
